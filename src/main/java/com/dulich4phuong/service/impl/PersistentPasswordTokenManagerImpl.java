...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.dulich4phuong.service.impl.PasswordTokenManager#generateRecoveryToken(com.dulich4phuong.model.User)
     */
    @Override
    ...
    /**
     * @see com.dulich4phuong.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.dulich4phuong.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.dulich4phuong.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
