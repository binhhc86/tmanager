...
import com.dulich4phuong.dao.UserDao;
import com.dulich4phuong.model.User;
import com.dulich4phuong.service.MailEngine;
import com.dulich4phuong.service.UserExistsException;
import com.dulich4phuong.service.UserManager;
import com.dulich4phuong.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.dulich4phuong.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.dulich4phuong.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
